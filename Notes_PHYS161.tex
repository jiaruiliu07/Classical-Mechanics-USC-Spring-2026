...
\begin{document}
	...
	EXERCISE: Look at the dimensions of $c,\hbar, and G$. Create the Planck units- the Planck length, time, and mass, by combining the three constants in a unique way that they create a constant for length, time, and mass.
